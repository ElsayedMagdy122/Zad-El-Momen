        ...
        try {
            ...
            if (!isNetworkAvailable) {
                sendEffect(PermissionsEffect.ShowToast(ToastDetails(
                    title = UiText.StringResource(Res.string.error),
                    message = UiText.StringResource(Res.string.no_internet_connection),
                    icon = Res.drawable.ic_close_circle
                )))
            ...
            sendEffect(PermissionsEffect.ShowToast(ToastDetails(
                title = UiText.StringResource(Res.string.error),
                message = UiText.StringResource(Res.string.error),
                icon = Res.drawable.ic_close_circle
            )))
        }
    }
