...
val repositoryModule = module {
    ...
    single<SettingsRepository> { SettingsRepositoryImpl(get(named("settings_ds"))) }
    single<PrayerNotificationsRepository> { PrayerNotificationsRepositoryImpl(get(named("settings_ds"))) }
    ...
    single<CompanionRepository> { CompanionRepositoryImpl(get(named("settings_ds"))) }
    ...
    single<ReminderSettingsRepository> {
        ReminderSettingsRepositoryImpl(dataStore = get(named("settings_ds")))
    }
