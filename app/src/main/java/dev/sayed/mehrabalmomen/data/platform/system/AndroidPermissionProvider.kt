...
/**
 * Android implementation of [PermissionProvider] for checking permissions and API-specific capabilities.
 */
class AndroidPermissionProvider(
    ...
    override fun isExactAlarmPermissionRequired(): Boolean {
